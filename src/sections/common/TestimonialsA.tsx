            ...
            <div className="container">
                <div className="section-title-two text-left sec-title-animation animation-style2">
                    <div className="section-title-two__tagline-box">
                        ...
                        <span className="section-title-two__tagline">{t("aboutPage.testimonialTagline")}</span>
                    </div>
                    <h2 className="section-title-two__title title-animation">
                        <TextAnimation text={t("aboutPage.testimonialTitleLine1")} textColor='black' isSpan={false} />
                        <TextAnimation text={t("aboutPage.testimonialTitleLine2")} isSpan={false} textColor='#6232F8' />
                    </h2>
                </div>
