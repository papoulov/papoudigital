...
import serviceImg1 from "../../../public/assets/images/web1.png";
import serviceImg2 from "../../../public/assets/images/africa2.png";
import pointsImg from "../../../public/assets/images/web2.png";
...
const WebDesignMain: React.FC = () => {
  ...
  const skills: Skill[] = [
    { name: t("servicesPage.web.skill1"), percent: 93 },
    { name: t("servicesPage.web.skill2"), percent: 90 },
    { name: t("servicesPage.web.skill3"), percent: 87 },
  ];

  const featureLeft = [
    t("servicesPage.web.feature1"),
    t("servicesPage.web.feature2"),
    t("servicesPage.web.feature3"),
  ];

  const featureRight = [
    t("servicesPage.web.feature4"),
    t("servicesPage.web.feature5"),
    t("servicesPage.web.feature6"),
  ];

  const cards = [
    { icon: icon1, text: t("servicesPage.web.card1") },
    { icon: icon2, text: t("servicesPage.web.card2") },
    { icon: icon3, text: t("servicesPage.web.card3") },
    { icon: icon4, text: t("servicesPage.web.card4") },
  ];

  const whyPoints = [
    t("servicesPage.web.whyPoint1"),
    t("servicesPage.web.whyPoint2"),
    t("servicesPage.web.whyPoint3"),
    t("servicesPage.web.whyPoint4"),
  ];
          ...
          <div className="col-xl-8 col-lg-7">
            <div className="services-details__left">
              <div className="services-details__img">
                <Image src={serviceImg1} width={850} height={400} alt="Web and mobile development" />
              </div>

              <div className="services-details__content">
                <h3 className="services-details__title-1">{t("servicesPage.web.title1")}</h3>
                <div className="services-details__shape-1"></div>
                <p className="services-details__text-1">{t("servicesPage.web.text1")}</p>

                <h3 className="services-details__title-2">{t("servicesPage.web.title2")}</h3>
                <p className="services-details__text-2">{t("servicesPage.web.text2")}</p>
                  ...
                  <div className="row">
                    <div className="col-xl-6 col-lg-6">
                      <div className="services-details__progress-left">
                        <h3 className="services-details__progress-left-title">{t("servicesPage.web.impactTitle")}</h3>
                        <p className="services-details__progress-left-text">{t("servicesPage.web.impactText")}</p>
                      </div>
                    </div>
                ...
                <h3 className="services-details__title-3">{t("servicesPage.web.whyTitle")}</h3>
                <p className="services-details__text-3">{t("servicesPage.web.whyText")}</p>
                ...
                <p className="services-details__text-4">{t("servicesPage.web.text4")}</p>

                <div className="services-details__img-two">
                  <Image src={serviceImg2} width={852} height={300} alt="Web and mobile delivery" />
                </div>

                <h3 className="services-details__title-4">{t("servicesPage.common.getStarted")}</h3>
                <p className="services-details__text-5">{t("servicesPage.web.text5")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-4 col-lg-5">
            <div className="services-details__right">
              ...
              <div className="services-details__contact-box">
                ...
                <span></span>
                <p className="services-details__contact-text">{t("servicesPage.web.contactText")}</p>
